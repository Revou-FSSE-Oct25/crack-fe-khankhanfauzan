...
import { updateMaintenanceStatus } from "@/services/maintenances";
import { toast } from "sonner";
import { ComplaintStatus } from "@/types/maintenances";
import {
    Select,
    SelectContent,
    SelectItem,
...
export default function ComplaintDetailPage() {
    ...
    useEffect(() => {
        ...
        getMaintenanceById(id, { token })
            .then((value) => {
                ...
                if (value.data) {
                    setUpdateStatus(value.data.status);
                    setAdminNotes(value.data.adminNotes || "");
                }
            })
    ...
    return (
        <div className="p-4 mx-auto space-y-6 max-w-5xl">
